...
export function MostRead({ showThumbnails, isNumberLeft }) {
	return (
		<>
			<section className="section-most-read">
									...
									<div className="most-read-articles">
										<div className="most-read-item">
											...
											<div className="article-description">
												فلاي دبي تسجل نمواً استثنائياً وتنقل 3.37 مليون مسافر
												خلال الربع الأول 2023
											</div>
										</div>
										<div className="most-read-item">
											{showThumbnails !== undefined &&
